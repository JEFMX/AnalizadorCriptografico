...
def cifrado(key, nonce,TextoEnClaro):  
    ...
    time.sleep(1) #es necesario apra calcular el tiempo
    return TextoCifrado
...
def ChaCha20_algoritmo():
    key,nonce,TextoEnClaro = generar_key_nonce_entrada()
...
def decifrar(resultCifrado,key,nonce):
    ...
    time.sleep(1) #es necesario apra calcular el tiemp 
